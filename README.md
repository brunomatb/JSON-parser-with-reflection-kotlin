...
Esta é uma biblioteca Programada em Kotlin que permite a conversão de objetos em um JSON e oferece recursos como manipulação de propriedades, visitantes, reflexão/anotações e observadores. Ela foi projetada para facilitar o trabalho com um JSON em Kotlin.
# Recursos Principais:
